...
# create the UI for the converter
...
class UI(tk.Tk):
    def __init__(self, converter):
        ...
        # RestrictNumberOnly will prevent users from entering any invalid characters, e.g., letters, into the entry box
    ...
    def restrictNumberOnly(self, action, string):
        regex = register.compile(r"[0-9,]*?(\.)?[0-9,]*$")
